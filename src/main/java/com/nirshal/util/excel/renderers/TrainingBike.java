...
public class TrainingBike extends Training {

    @Override
    public UnitsType getType() {
        return UnitsType.CYCLING;
    }
    ...
    public List<List<String>> toCSVRecord() {
        ...
        row3.add("");
        //6 - Ritmo Medio
        row1.add(this.getMeanSpeedString());
        row2.add("");
        row3.add("");
        //7 - Splits
        for  (Interval interval : this) {
            if (interval.isFasterThan(this.getType().getRecoverySpeed())){
                ...
                row3.add(interval.getSpeedString());
